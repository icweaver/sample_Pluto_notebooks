...
# ╔═╡ 5b991942-3f16-4210-9ac8-72e57a3392a8
using Plots
...
Another powerful feature of `PyCall.jl` is `pyimport`. This allows us to import Python packages and use them directly in a Julia session without needing to apply any function wrapping. Python objects will be automatically converted to Julia objects when possible, and vice-versa!

Let's try this out with the popular [`lightkurve`](https://docs.lightkurve.org/index.html#) package to pull down some TESS data and visualize it:
"""

# ╔═╡ 04b5e2f6-ae95-40eb-87e6-0e45dbf1aed3
lk = pyimport("lightkurve")

# ╔═╡ aba89726-296e-4eaa-8e5f-4106bd4e1c3f
...
p = pixelfile.plot(); plt.savefig("tpf_KIC.png")

# ╔═╡ e02f68c1-5541-41be-912e-faac2dd22599
LocalResource("tpf_KIC.png")

# ╔═╡ 7cd4248e-a217-4651-a2b5-94240adb800c
md"""
Computing the corresponding light curve and viewing the AstroPy table directly in `Pluto.jl` is a breeze:
"""

# ╔═╡ e442eab3-ba32-433d-8cfd-3ba2160b94ba
lc = pixelfile.to_lightcurve()

# ╔═╡ 1e52a3b2-cf60-4ce6-b423-70f8ff741caa
md"""
Being able to access the data stored in Python objects and work with them in native Julia formats gives us easy access to the full Julia ecosystem!
"""

# ╔═╡ b731fc24-37d7-4407-a367-ee1e03856ac6
plotly()

# ╔═╡ c7222a72-cbff-4915-977c-454d7ad5dcfa
plot(lc.time.value, lc.flux)
